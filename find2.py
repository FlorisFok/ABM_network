...
def analyse_network(connectivity, characteristics) :
    ...
    return segreg_ind[0], segreg_ind[1], segreg_ind[2]
...
def main(settings, repeats):
    global DELTA, GAMMA, C, B1, B2, B3, SIGMA, ALPHA, MIN_PROP, pos_link, MINIMAL, MAX_FRIEND, zeros, n_zeros
    B1, B2, B3 = settings
    DELTA, GAMMA, C, SIGMA = [0.05000000000000004, 0.6499999999999999, 0.175, 0.035]
    #[0.12500000000000003, 0.6499999999999999, 0.19999999999999998, 0.01]

    # Plot info
    # plot_data = {'av_degree':[], 'RCHDEN':[], 'RELDEN':[], 'RHO2':[],
    #              'segreg_ind0':[], 'segreg_ind1':[], 'segreg_ind2':[]}
    plot_data = {'segreg_ind0':[], 'segreg_ind1':[], 'segreg_ind2':[]}

    # _string = ['av_degree', 'RCHDEN', 'RELDEN', 'RHO2', 'segreg_ind0', 'segreg_ind1', 'segreg_ind2']
    _string = ['segreg_ind0', 'segreg_ind1', 'segreg_ind2']
    ...
    #              'segreg_ind0':[], 'segreg_ind1':[], 'segreg_ind2':[]}
    true_data = {'segreg_ind0':[], 'segreg_ind1':[], 'segreg_ind2':[]}
